  ...
  return (
    <form className="flex max-w-xl md:mx-auto" min-width="400 500 600 700 800">
      ...
      <div>
        <input
          type="submit"
          className="w-full px-4 py-2 text-base font-medium text-center text-white bg-red-400 dark:bg-blue-600 dark:border-blue-600 border border-blue-700 cursor-pointer rounded-r-xl  hover:bg-blue-800 dark:hover:border-blue-700 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          value="Search"
